...
def main():
    ...
    name = "Vansh Singhal" # TODO: Insert your name between the double quotes

    print(f"{name}, Welcome to the CSS course!")
    print("Hi all, my name is Vansh Singhal. I am a freshmen at Terra Environmental Research Institute in Miami, Florda. A fun fact about me is that I love to code and I am my school's debate team captain.")
