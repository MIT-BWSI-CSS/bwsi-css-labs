...
def main():
    ...
    name = "Dylan Huang" # TODO: Insert your name between the double quotes

    print(f"{name}, Welcome to the CSS course!")
    print(f"Hello everyone! I'm Dylan Huang, a sophomore from Massachusetts. I enjoy playing tennis and running! I'm looking forward to this course!")
